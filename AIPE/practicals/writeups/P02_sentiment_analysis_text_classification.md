...
## 4. Code
- Main script (auto-uses TextBlob when present, else falls back to the lexicon): [`p02_sentiment_analysis.py`](../code/p02_sentiment_analysis.py)
- Offline-only lexicon classifier (zero dependencies): [`p02_lexicon_fallback.py`](../code/p02_lexicon_fallback.py)
