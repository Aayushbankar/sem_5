...
> ⚠️ **Responsible-use note:** GenAI can **hallucinate** and reflect **bias**; outputs in medicine/security must be verified by a human expert. (Detailed in Unit 2 §2.4 and Unit 5 §5.7.)
...
- Template file: [`p01_genai_task_templates.txt`](../code/p01_genai_task_templates.txt)
