---
title: "Unit 5 — IoT Cloud Platforms and Applications"
sidebar:
  order: 5
---
...
> **Related practicals:** [P10](./P10%20—%20Thingspeak%20Http%20Temperature.md), [P11](./P11%20—%20Ultrasonic%20Thingspeak%20Cloud.md), [P12](./P12%20—%20Blynk%20Two%20Way%20Dashboard.md), [P13](./P13%20—%20Soil%20Moisture%20Dht%20Cloud%20Thresholds.md), [P14](./P14%20—%20Mini%20Project%20Smart%20Agriculture%20Guide.md)
...
> **Exam one-liner:** "Smart Agriculture closes the loop — sensor detects dry soil, the controller starts the pump, and the farmer watches it all from a phone." (Full walkthrough in [P14](./P14%20—%20Mini%20Project%20Smart%20Agriculture%20Guide.md).)
...
| 🛠️ **Builder** | wiring things yourself | Watch the ThingSpeak/Blynk build-alongs → run [P10](./P10%20—%20Thingspeak%20Http%20Temperature.md)–[P12](./P12%20—%20Blynk%20Two%20Way%20Dashboard.md) |
...
*Back to: [UNIT 1 — Introduction to IoT](./Unit%201%20—%20Introduction%20to%20IoT.md)*
