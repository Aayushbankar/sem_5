---
title: "Unit 3 — Ethereum and Smart Contracts"
sidebar:
  order: 3
---
...
**Syllabus weightage:** 12 hrs / **30%** — the biggest unit. | **Related practicals:** [P07](./P07%20—%20Smart%20Contract%20Evm.md), [P08](./P08%20—%20Erc20%20Token.md)
...
`totalSupply()`, `balanceOf()`, `transfer()`, `transferFrom()`, `approve()`, `allowance()` + events `Transfer`, `Approval`. (See [P08](./P08%20—%20Erc20%20Token.md).)
...
```
Deployed in Remix → a `setMessage` call costs gas; `message()` reads are free. Full walkthrough with screenshots in [P07](./P07%20—%20Smart%20Contract%20Evm.md).
...
| 🛠️ **Builder** | writing code yourself | Watch the build-along → deploy [P07](./P07%20—%20Smart%20Contract%20Evm.md) & [P08](./P08%20—%20Erc20%20Token.md) in Remix |
...
- Deploy the [P08 token](./P08%20—%20Erc20%20Token.md) on Sepolia and mint/transfer to yourself.
- Explain to a friend why a failed transaction still costs gas.
- Say the 6 rows of the Bitcoin vs Ethereum table from memory.

---

*Next: [UNIT 4 — Enterprise & Private Blockchains](./Unit%204%20—%20Enterprise%20and%20Private%20Blockchains.md)*
...
- **30%** — the biggest unit. | **Related practicals:** [P07](./P07%20—%20Smart%20Contract%20Evm.md), [P08](./P08%20—%20Erc20%20Token.md)
...
> the biggest unit. | **Related practicals:** [P07](./P07%20—%20Smart%20Contract%20Evm.md), [P08](./P08%20—%20Erc20%20Token.md)
