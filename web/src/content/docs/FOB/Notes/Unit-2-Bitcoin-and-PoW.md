...
**Syllabus weightage:** 8 hrs / 15% | **Related practicals:** [P05](./P05%20—%20Nonce%20Mining%20Difficulty.md), [P06](./P06%20—%20Wallets%20Mnemonic%20Bip39.md)
...
- **Anyone who knows the phrase controls every derived address** — write it on paper, never type it into a website. See [P06](./P06%20—%20Wallets%20Mnemonic%20Bip39.md) to build one yourself.
...
- Because hashing is one-way, miners can't "cheat" by predicting a winning nonce — expected work = `Target/2²⁵⁶` hashes. (Try it in [P05](./P05%20—%20Nonce%20Mining%20Difficulty.md).)
...
| 🛠️ **Builder** | writing code yourself | Watch the build-along → run [P05](./P05%20—%20Nonce%20Mining%20Difficulty.md) & [P06](./P06%20—%20Wallets%20Mnemonic%20Bip39.md), then break them |
...
- Run [P05](./P05%20—%20Nonce%20Mining%20Difficulty.md), crank the difficulty up, and watch the mining time explode — that's the 10-minute-block idea in miniature.
...
*Next: [UNIT 3 — Ethereum & Smart Contracts](./Unit%203%20—%20Ethereum%20and%20Smart%20Contracts.md)*
