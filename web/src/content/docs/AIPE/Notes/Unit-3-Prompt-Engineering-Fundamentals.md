---
title: "Unit 3 — Prompt Engineering Fundamentals"
sidebar:
  order: 3
---
...
> **Related practicals:** [P05](./P05%20—%20Prompt%20Design%20And%20Refinement.md), [P06](./P06%20—%20Zero%20Shot%20Few%20Shot%20Role%20Based.md), [P08](./P08%20—%20Task%20Based%20Prompt%20Engineering.md)
...
**Practical tie-ins**
- [P05](./P05%20—%20Prompt%20Design%20And%20Refinement.md) — 3-iteration before/after refinement
- [P06](./P06%20—%20Zero%20Shot%20Few%20Shot%20Role%20Based.md) — methods with worked examples
- [P08](./P08%20—%20Task%20Based%20Prompt%20Engineering.md) — task prompts + optimization checklists
...
| 🛠️ **Builder** | writing code yourself | Watch a "prompt engineering crash course" → run [P05](./P05%20—%20Prompt%20Design%20And%20Refinement.md) iterations live |
...
- Run the [P05](./P05%20—%20Prompt%20Design%20And%20Refinement.md) 3-iteration email example yourself and note which iteration gave the biggest jump.
- Answer the High-Yield Q6 (design a prompt) out loud with the I-C-I-O structure.

---

*Next: [UNIT 4 — Prompt Engineering Techniques](./Unit%204%20—%20Prompt%20Engineering%20Techniques.md)*
