---
title: "P02 — Sentiment Analysis Text Classification"
sidebar:
  order: 2
---
...
## 4. Code
- Main script (auto-uses TextBlob when present, else falls back to the lexicon): [`p02_sentiment_analysis.py`](./p02_sentiment_analysis.py.md)
- Offline-only lexicon classifier (zero dependencies): [`p02_lexicon_fallback.py`](./p02_lexicon_fallback.py.md)
