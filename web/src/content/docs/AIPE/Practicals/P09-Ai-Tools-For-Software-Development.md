---
title: "P09 — Ai Tools For Software Development"
sidebar:
  order: 9
---
...
**Verification (actual run of [`p09_code_gen_debugging_cases.py`](./p09_code_gen_debugging_cases.py.md)):**
```
...
## 10. Resources
- Run the cases: [`p09_code_gen_debugging_cases.py`](./p09_code_gen_debugging_cases.py.md)
