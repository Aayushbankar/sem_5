---
title: "P06 — Cloud Databases Comparison"
sidebar:
  order: 6
---
...
> When running **Cloud Databases Comparison** in a real environment, it almost never works perfectly the first time. 
> 
...
- **Autonomous** — auto CPU/storage scaling, no tuning |
- **SQL vs NoSQL?** — SQL: fixed schema, ACID, vertical scale; NoSQL: flexible schema, horizontal scale, eventual consistency.
- **What is a managed database?** — Provider handles provisioning, patching, backup, HA; you use it via APIs/SQL.
- **Vertical vs horizontal scaling?** — Bigger machine vs more machines (sharding/replicas).
- **Why choose Atlas for a document app?** — Native horizontal sharding + free tier + flexible schema.
- **What does "autonomous" mean in Oracle ATP?** — Self-driving: auto-provisioning, auto-tuning, auto-patching, auto-scaling.
