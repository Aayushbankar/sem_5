...
Script: [[p12_study_assistant.py|`p12_study_assistant.py`]] — reuses `ChatClient` from P10 and adds a tiny retrieval layer. Three commands:
...
## 9. Resources
- Prompt patterns from Units 3–4 of these notes: [[Unit 3 — Prompt Engineering Fundamentals|UNIT 3]], [[Unit 4 — Prompt Engineering Techniques|UNIT 4]]
- OpenAI cookbook: https://cookbook.openai.com
- Gemini API docs: https://ai.google.dev/gemini-api/docs
- Script: [[p12_study_assistant.py|`p12_study_assistant.py`]]
