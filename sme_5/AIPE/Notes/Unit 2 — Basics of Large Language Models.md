...
subject: AIPE
status: not-started
tags: [subject/aipe, unit/2]
unit: 2
title: Basics of Large Language Models (LLMs)
hours: 6
weightage: "15%"
related_practicals: [P03, P04, P10]
---
...
> **Related practicals:** [[P03 — Llm Behavior Analysis|P03]], [[P04 — Llm Capabilities Limitations Hallucinations|P04]], [[P10 — Ai Chatbot Api Python|P10]]
...
**Practical tie-ins**
- [[P03 — Llm Behavior Analysis|P03]] — prompt variation & consistency experiments
- [[P04 — Llm Capabilities Limitations Hallucinations|P04]] — hallucination test bank + rubric
- [[P10 — Ai Chatbot Api Python|P10]] — calling a real LLM via API
...
| 🛠️ **Builder** | writing code yourself | Watch Karpathy's "state of GPT" → run [[P10 — Ai Chatbot Api Python|P10]] with `--mock` |
| 🔧 **Tinkerer** | experimenting & demos | Run [[P03 — Llm Behavior Analysis|P03]] and [[P04 — Llm Capabilities Limitations Hallucinations|P04]] on a free chatbot |
...
- Run [[P04 — Llm Capabilities Limitations Hallucinations|P04]] and correctly *predict* which counterfactual question will trigger a hallucination.
- Explain why a 200-page document overflows a context window and what RAG does about it (you'll build it in P11).

---

*Next: [[Unit 3 — Prompt Engineering Fundamentals|UNIT 3 — Prompt Engineering Fundamentals]]*
