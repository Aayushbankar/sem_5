...
subject: AIPE
status: not-started
tags: [subject/aipe, unit/1]
unit: 1
title: "Foundations of Artificial Intelligence & Generative AI"
hours: 6
weightage: "15%"
related_practicals: [P01, P02]
---
...
> **Related practicals:** [[P01 — Genai Tools Tasks And Domains|P01]], [[P02 — Sentiment Analysis Text Classification|P02]]
...
**Practical tie-ins**
- [[P01 — Genai Tools Tasks And Domains|P01]] — GenAI task-type matrix + tool comparison
- [[P02 — Sentiment Analysis Text Classification|P02]] — NLP in code: sentiment + classification
...
| 🛠️ **Builder** | writing code yourself | Watch the NLP/Python intro video → then run [[P02 — Sentiment Analysis Text Classification|P02]] code |
...
- Run [[P02 — Sentiment Analysis Text Classification|P02]] and predict which review is positive before the script prints it.

---

*Next: [[Unit 2 — Basics of Large Language Models|UNIT 2 — Basics of Large Language Models]]*
