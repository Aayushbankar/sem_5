...
subject: FOB
status: not-started
tags: [subject/fob, unit/1]
unit: 1
title: Foundations of Decentralization
hours: 10
weightage: "20%"
related_practicals: [P01, P02, P03, P04]
---
...
> **Related practicals:** [[P01 — Cryptographic Hash Avalanche|P01]], [[P02 — Public Private Keys Digital Signatures|P02]], [[P03 — Basic Blockchain Python|P03]], [[P04 — Merkle Tree|P04]]
...
> [!example] See it live
> [[P01 — Cryptographic Hash Avalanche|P01]] runs this in Python — changing `Hello, World!` → `Hello, World?` flips **113 of 256 bits**.
...
> [!example] See it live
> [[P02 — Public Private Keys Digital Signatures|P02]] generates a key pair, signs, and proves tampered messages & wrong keys are rejected.
...
> [!example] See it live
> [[P03 — Basic Blockchain Python|P03]] — change `"sends 1 coin"` → `"sends 100 coins"` in a block and the validator instantly rejects the chain.
...
> [!example] See it live
> [[P04 — Merkle Tree|P04]] — builds trees for 4 and 5 transactions and shows a tampered leaf changes the root.
...
| 🛠️ **Builder** | writing code yourself | Watch the build-along video → then run [[FOB — Overview|P01–P04]] code and break them |
...
- Run [[P02 — Public Private Keys Digital Signatures|P02]] and predict which verification fails when you tamper with the message.
- Re-tell the Byzantine Generals story in your own words — if you can, the concept is yours.

---

*Next: [[Unit 2 — Bitcoin and PoW|UNIT 2 — Bitcoin & The Proof-of-Work Era]]*
