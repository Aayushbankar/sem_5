...
subject: CDCT
status: not-started
tags: [subject/cdct, practical, unit/5]
practical: 9
unit: 5
hours: 2
---
...
| File | Purpose |
|---|---|
| [[p09_docker-compose.yml|`p09_docker-compose.yml`]] | MinIO server (ports 9000 API / 9001 console) + KMS key |
| [[p09_readonly_policy.json|`p09_readonly_policy.json`]] | IAM policy: `GetObject`, `ListBucket` (read-only) |
| [[p09_admin_policy.json|`p09_admin_policy.json`]] | IAM policy: `PutObject`, `GetObject`, `DeleteObject` |
| [[p09_bucket_policy.json|`p09_bucket_policy.json`]] | Example *bucket* policy (AWS-style) for reference |
| [[p09_setup.sh|`p09_setup.sh`]] | End-to-end setup + verification script |
