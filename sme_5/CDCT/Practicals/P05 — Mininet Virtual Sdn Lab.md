...
subject: CDCT
status: not-started
tags: [subject/cdct, practical, unit/3]
practical: 5
unit: 3
hours: 4
---
...
flowchart TB
    ...
    S2 --- H4[h4 10.0.0.4]
```
This is exactly the topology in [[p05_mininet_2switch_4host.py|`p05_mininet_2switch_4host.py`]].
...
File: [[p05_mininet_2switch_4host.py|`p05_mininet_2switch_4host.py`]]
