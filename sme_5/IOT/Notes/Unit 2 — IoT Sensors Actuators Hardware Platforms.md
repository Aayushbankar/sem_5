...
subject: IOT
status: not-started
tags: [subject/iot, unit/2]
unit: 2
title: IoT Sensors, Actuators and Hardware Platforms
hours: 6
weightage: "25%"
related_practicals: [P02, P04]
---
...
> **Related practicals:** [[P02 — Compare Hardware Platforms Esp32 Pinout|P02]], [[P04 — External Led Blink Toggle|P04]], [[P05 — Pir Ldr Sensor Interface|P05]], [[P06 — Dht Temperature Humidity Sensor|P06]], [[P07 — Ultrasonic Distance Sensor|P07]]
...
| 🛠️ **Builder** | wiring things yourself | Watch a sensor tutorial → then run [[P05 — Pir Ldr Sensor Interface|P05]]–[[P07 — Ultrasonic Distance Sensor|P07]] |
...
*Next: [[Unit 3 — ESP32 and Arduino IDE Development|UNIT 3 — Introduction to ESP32 & Development with Arduino IDE]]*
