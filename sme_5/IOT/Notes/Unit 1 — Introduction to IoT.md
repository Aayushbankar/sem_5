...
subject: IOT
status: not-started
tags: [subject/iot, unit/1]
unit: 1
title: Introduction to IoT
hours: 4
weightage: "10%"
related_practicals: [P01]
---
...
> **Related practicals:** [[P01 — Iot Architecture Layers|P01]]
...
| 🛠️ **Builder** | wiring things yourself | Watch the intro → jump to [[P01 — Iot Architecture Layers|P01]] and map real sensors to layers |
