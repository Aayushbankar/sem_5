...
> 💡 **Why this is exam gold:** this single practical joins three units — ultrasonic sensing (Unit 2/3), HTTP APIs (Unit 5) and a real application. "Explain how you would measure a tank's fill level with an ultrasonic sensor" is a classic viva/design question.
...
> Full sketch: [`p11_thingspeak_http_ultrasonic.ino`](../code/p11_thingspeak_http_ultrasonic.ino)
