...
> Full sketch: [`p12_blynk_two_way_dashboard.ino`](../code/p12_blynk_two_way_dashboard.ino)

> ⚠️ **Note:** `Blynk.begin()` handles Wi-Fi + cloud connection automatically — no manual `WiFi.begin()` needed (the library manages it internally).
