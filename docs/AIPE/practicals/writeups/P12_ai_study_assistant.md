...
Script: [`p12_study_assistant.py`](../code/p12_study_assistant.py) — reuses `ChatClient` from P10 and adds a tiny retrieval layer. Three commands:
...
## 9. Resources
- Prompt patterns from Units 3–4 of these notes: [UNIT 3](../../notes/UNIT_3_Prompt_Engineering_Fundamentals.md), [UNIT 4](../../notes/UNIT_4_Prompt_Engineering_Techniques.md)
- OpenAI cookbook: https://cookbook.openai.com
- Gemini API docs: https://ai.google.dev/gemini-api/docs
- Script: [`p12_study_assistant.py`](../code/p12_study_assistant.py)
