...
> ⚠️ **Voltage caution:** the FC-28 module's analog output is a divider — if you feed it **3V3** instead of 5 V, its output stays within the ESP32's ADC range and is safe.
...
> Full sketch: [`p13a_soil_moisture_dht_serial.ino`](../code/p13a_soil_moisture_dht_serial.ino)
...
> Full sketch: [`p13b_soil_dht_cloud_threshold.ino`](../code/p13b_soil_dht_cloud_threshold.ino)
