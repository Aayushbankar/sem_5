...
subject: FOB
status: not-started
tags: [subject/fob, unit/5]
unit: 5
title: "Security, Emerging Trends & Green Energy"
related_practicals: [P08, P10]
---
# UNIT 5 — Security, Emerging Trends & Green Energy 🔐🌱

**Syllabus weightage:** 8 hrs / 15% | **Related practicals:** [[P08 — Erc20 Token|P08]], [[P10 — Case Study Security Green Energy Dao|P10]]
...
- This ties to UNIT 3 practical [[P08 — Erc20 Token|P08]] — a green-energy token contract.
...
| 🛠️ **Builder** | hands-on | Re-run [[P08 — Erc20 Token|P08]]; try a re-entrancy CTF |
...
*End of FOB notes. 🎉 Next: revisit [[Unit 1 — Foundations of Decentralization|UNIT 1]] to start your revision loop.*
