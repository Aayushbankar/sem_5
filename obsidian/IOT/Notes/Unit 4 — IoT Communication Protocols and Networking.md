...
subject: IOT
status: not-started
tags: [subject/iot, unit/4]
unit: 4
title: "IoT Communication Protocols & Networking"
hours: 4
weightage: "10%"
related_practicals: [P08, P09, P14]
---
...
> **Related practicals:** [[P08 — Esp32 Mqtt Publisher|P08]], [[P09 — Esp32 Mqtt Subscriber Remote Control|P09]], [[P14 — Mini Project Smart Agriculture Guide|P14]]
...
| 🛠️ **Builder** | wiring things yourself | Watch the MQTT build-along → then run [[P08 — Esp32 Mqtt Publisher|P08]]–[[P09 — Esp32 Mqtt Subscriber Remote Control|P09]] |
...
*Next: [[Unit 5 — IoT Cloud Platforms and Applications|UNIT 5 — IoT Cloud Platforms and Applications of IoT]]*
