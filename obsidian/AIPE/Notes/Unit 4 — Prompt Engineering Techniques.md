...
subject: AIPE
status: not-started
tags: [subject/aipe, unit/4]
unit: 4
title: Prompt Engineering Techniques
hours: 9
weightage: "20%"
related_practicals: [P07, P08, P11]
---
...
> **Related practicals:** [[P07 — Chain Of Thought Prompt Chaining|P07]], [[P08 — Task Based Prompt Engineering|P08]], [[P11 — Document Qa Basic Rag|P11]]
...
**Practical tie-ins**
- [[P07 — Chain Of Thought Prompt Chaining|P07]] — worked CoT + chaining examples
- [[P08 — Task Based Prompt Engineering|P08]] — 3 task prompts + optimization checklists
- [[P11 — Document Qa Basic Rag|P11]] — runnable RAG pipeline (offline)
...
| 🛠️ **Builder** | writing code yourself | Run [[P07 — Chain Of Thought Prompt Chaining|P07]] then [[P11 — Document Qa Basic Rag|P11]] and break them |
...
- Run [[P11 — Document Qa Basic Rag|P11]] `--mock` and identify each of the 4 RAG stages in its output.
- Explain to a friend why RAG beats "please remember my PDF" — the word *grounding* should appear.

---

*Next: [[Unit 5 — AI Application Development Agentic AI|UNIT 5 — AI Application Development: Generative AI & Agentic AI]]*
