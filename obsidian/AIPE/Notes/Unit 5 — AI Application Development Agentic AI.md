...
> **Related practicals:** [[P09 — Ai Tools For Software Development|P09]], [[P10 — Ai Chatbot Api Python|P10]], [[P11 — Document Qa Basic Rag|P11]], [[P12 — Ai Study Assistant|P12]]
...
**Applications**
- [[P10 — Ai Chatbot Api Python|P10]] — chatbot + `--mock` + real-key setup
- [[P11 — Document Qa Basic Rag|P11]] — RAG document Q&A (offline)
- [[P12 — Ai Study Assistant|P12]] — capstone Study Assistant + 3 design docs
...
| 🛠️ **Builder** | writing code yourself | Run [[P10 — Ai Chatbot Api Python|P10]] → [[P11 — Document Qa Basic Rag|P11]] → [[P12 — Ai Study Assistant|P12]] with `--mock` |
...
- Run [[P10 — Ai Chatbot Api Python|P10]] `--mock`, then [[P11 — Document Qa Basic Rag|P11]] `--mock`, then [[P12 — Ai Study Assistant|P12]] `--mock` — you have now built the app ladder chatbot → RAG → study assistant.
...
*🎓 You've finished the 5 units. Next steps: run the practicals, then revise via [[AIPE Resources|RESOURCES]].*
