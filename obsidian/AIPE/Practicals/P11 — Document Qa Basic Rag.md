...
Script: [[p11_rag_document_qa.py|`p11_rag_document_qa.py`]], sample doc: [[p11_sample_document.txt|`p11_sample_document.txt`]]
...
- Script + sample doc: [[p11_rag_document_qa.py|`p11_rag_document_qa.py`]] · [[p11_sample_document.txt|`p11_sample_document.txt`]]
