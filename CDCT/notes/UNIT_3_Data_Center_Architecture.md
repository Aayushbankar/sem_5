...
> **Related practicals:** [P05](../practicals/writeups/P05_mininet_virtual_sdn_lab.md)
...
```mermaid
flowchart TB
    subgraph SPINE[Spine layer - 4 switches]
        SP1 & SP2
    end
...
```mermaid
flowchart TB
    A[Application layer<br/>Apps: firewall, LB, network monitoring]
    N[N'BOUND API<br/>REST]
    C[Control layer<br/>SDN Controller<br/>- global network view<br/>- decides paths]
    S[S'BOUND protocol<br/>OpenFlow]
    D[Data layer<br/>SDN switches - only forward]
    A --> N --> C --> S --> D
```
...
| 🛠️ **Builder** | doing it | Run [P05](../practicals/writeups/P05_mininet_virtual_sdn_lab.md) in the lab VM |
...
*Next: [UNIT 4 — Cloud Storage and Database Services](./UNIT_4_Cloud_Storage_and_Database_Services.md)*
